...
const DEFAULT_USERS = [
  ...
  { id: 'u2', name: 'Minh Tuß║Ñn', role: 'staff', walletBalance: 0 },
  { id: 'u3', name: 'H╞░╞íng Giang', role: 'staff', walletBalance: 0 },
  { id: 'u4', name: 'Ho├áng Nam', role: 'staff', walletBalance: 15000 }
];

const MOCK_MENU = [
  { id: 'm1', name: 'Tr├á Sß╗»a Tr├ón Ch├óu', price: 35000, category: 'Milk Tea' },
  { id: 'm2', name: 'C├á Ph├¬ Sß╗»a ─É├í', price: 29000, category: 'Coffee' },
  { id: 'm3', name: 'Matcha Latte', price: 45000, category: 'Tea' },
  { id: 'm4', name: 'Bß║íc Xß╗ëu', price: 32000, category: 'Coffee' },
  { id: 'm5', name: 'B├ính M├¼ Chß║ú', price: 20000, category: 'Food' }
];
...
const DEFAULT_SESSION = {
  ...
  discount: 10000,
  orders: [
    { id: 'o1', userId: 'u1', itemId: 'm1', qty: 1, note: '├ìt ─æ├í', status: 'paid' },
    { id: 'o2', userId: 'u2', itemId: 'm2', qty: 1, note: '', status: 'unpaid' },
    { id: 'o3', userId: 'u3', itemId: 'm3', qty: 1, note: 'Nhiß╗üu ─æ├í', status: 'paid' }
  ]
};
