(() => {
  ...
  const translations = {
    vi: {
      ...
      'work.kicker': '02 / DỰ ÁN TIÊU BIỂU', 'work.title': 'Bằng chứng, không phải trang trí.', 'work.lead': 'Mỗi dự án bắt đầu từ một vấn đề cụ thể và kết thúc bằng một kết quả có thể giải thích.',
      'filter.all': 'Tất cả', 'filter.empty': 'Chưa có dự án nào trong nhóm này.', 'project.case': 'Đọc case study',
    ...
    en: {
      ...
      'work.kicker': '02 / SELECTED WORK', 'work.title': 'Evidence, not decoration.', 'work.lead': 'Every project starts with a concrete problem and ends with an outcome that can be explained.',
      'filter.all': 'All work', 'filter.empty': 'No projects in this category yet.', 'project.case': 'Read case study',
  ...
  filterButtons.forEach((button) => button.addEventListener('click', () => {
    ...
    let visible = 0;
    projectCards.forEach((card) => { const show = filter === 'all' || card.dataset.category === filter; card.hidden = !show; if (show) visible += 1; });
